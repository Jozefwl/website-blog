                    ...
                    <div className="weather-widgets">
                        <div className="weather-container">
                            <div className="weather-widget">
                                ...
                                <iframe
                                    src="https://www.meteoblue.com/sk/po%C4%8Dasie/widget/daily/slovensk%c3%a1-kaj%c5%88a_slovensko_723580?geoloc=fixed&days=4&tempunit=CELSIUS&windunit=KILOMETER_PER_HOUR&precipunit=MILLIMETER&coloured=coloured&pictoicon=1&maxtemperature=1&mintemperature=1&windspeed=1&windgust=0&winddirection=1&uv=0&humidity=0&precipitation=1&precipitationprobability=1&spot=1&pressure=0&layout=light"
                                    frameBorder="0"
                                    scrolling="NO"
                                ...
                                <div>
                                    <a
                                        href="https://www.meteoblue.com/sk/po%C4%8Dasie/t%C3%BD%C5%žde%C5%88/slovensk%c3%a1-kaj%c5%88a_slovensko_723580?utm_source=daily_widget&utm_medium=linkus&utm_content=daily&utm_campaign=Weather%2BWidget"
                                        target="_blank"
                                        rel="noopener"
                                        style={{ color: 'white' }}
                                    >
                            ...
                            <div className="weather-widget">
                                <iframe
                                    src="https://www.meteoblue.com/sk/po%C4%8Dasie/widget/daily/stak%c4%8d%c3%adn_slovensko_723510?geoloc=fixed&days=4&tempunit=CELSIUS&windunit=KILOMETER_PER_HOUR&precipunit=MILLIMETER&coloured=coloured&pictoicon=1&maxtemperature=1&mintemperature=1&windspeed=1&windgust=0&winddirection=1&uv=0&humidity=0&precipitation=1&precipitationprobability=1&spot=1&pressure=0&layout=light"
                                    frameBorder="0"
                                    scrolling="NO"
                                    allowtransparency="true"
                                    sandbox="allow-same-origin allow-scripts allow-popups allow-popups-to-escape-sandbox"
                                ...
                                <div>
                                    <a
                                        href="https://www.meteoblue.com/sk/po%C4%8Dasie/t%C3%BD%C5%žde%C5%ň/stak%c4%8d%c3%adn_slovensko_723510?utm_source=daily_widget&utm_medium=linkus&utm_content=daily&utm_campaign=Weather%2BWidget"
                                        target="_blank"
                                        rel="noopener"
                                        style={{ color: 'white' }}
                                    >
